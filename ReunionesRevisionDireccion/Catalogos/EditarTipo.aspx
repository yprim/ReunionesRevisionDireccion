<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarTipo.aspx.cs" Inherits="ReunionesRevisionDireccion.Catalogos.EditarTipo" %>
     ...
     <div class="divRedondo">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <center>
                        <asp:Label ID="lblEditarTipo" runat="server" Text="Editar Tipo" Font-Size="Large" ForeColor="Black"></asp:Label>
                    </center>
            </div>
            <%-- fin titulo accion --%>
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                ...
                <div class="col-md-2 col-xs-2 col-sm-2">
                    <asp:Label ID="lblDescripcionTipo" runat="server" Text="Descripcion <span style='color:red'>*</span> " Font-Size="Medium" ForeColor="Black" CssClass="label"></asp:Label>
                </div>
