<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarUsuario.aspx.cs" Inherits="ReunionesRevisionDireccion.Catalogos.EditarUsuario" %>
     ...
     <div class="divRedondo">
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <center>
                        <asp:Label ID="lblEditarUsuario" runat="server" Text="Editar Usuario" Font-Size="Large" ForeColor="Black"></asp:Label>
                    </center>
            </div>
            <%-- fin titulo accion --%>
...
<script type="text/javascript">
        ...
        */
        function validarTexto(txtBox) {
            ...
            var descripcionUsuarioIncorrecto = document.getElementById('<%= divDescripcionUsuarioIncorrecto.ClientID %>');

            if (txtBox.value != "") {
                txtBox.className = "form-control";

                descripcionUsuarioIncorrecto.style.display = 'none';
            } else {
                txtBox.className = "form-control alert-danger";
                descripcionUsuarioIncorrecto.style.display = 'block';
            }
        }
    </script>
</asp:Content>
