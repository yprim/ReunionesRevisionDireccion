<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdministrarReunion.aspx.cs" Inherits="ReunionesRevisionDireccion.Catalogos.AdministrarReunion" %>
            ...
            <div class="col-md-12 col-xs-12 col-sm-12" style="text-align: center; overflow-y: auto;">
                ...
                <asp:Repeater ID="rpReunion" runat="server" >
                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                 <asp:LinkButton ID="btnVer" runat="server" ToolTip="Editar" OnClick="btnVer_Click" CommandArgument='<%# Eval("idReunion") %>'><span class="glyphicon glyphicon-eye-open"></span></asp:LinkButton>
