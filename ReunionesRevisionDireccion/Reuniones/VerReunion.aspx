<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerReunion.aspx.cs" Inherits="ReunionesRevisionDireccion.Reuniones.VerReunion"  MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="divCuadrado">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <center>
                        <asp:Label ID="lblNuevaReunion" runat="server" Text="Datos de reunión" Font-Size="Large" ForeColor="Black"></asp:Label>
                    </center>
                </div>
                <%-- fin titulo accion --%>
           ...
           <div class="divCuadrado">
            <div class="row">
                ...
                <div class="col-md-3 col-xs-3 col-sm-3 col-md-offset-9 col-xs-offset-9 col-sm-offset-9">
                    ...
                    <asp:Button ID="Button2" runat="server" Text="Regresar" CssClass="btn btn-primary" OnClick="btnRegresar_Click" />
                </div>
                <%-- fin boton cancelar --%>
