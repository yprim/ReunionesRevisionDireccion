<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerHallazgo.aspx.cs" Inherits="ReunionesRevisionDireccion.Hallazgos.VerHallazgo"  MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="divCuadrado">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <center>
                        <asp:Label ID="lblEliminarHallazgo" runat="server" Text=" Datos de hallazgo" Font-Size="Large" ForeColor="Black"></asp:Label>
                    </center>
                </div>
                <%-- fin titulo accion --%>
            ...
            <!-- Fin Archivos Reunion -->
             <%--  fincampos de reunión --%>
                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <div class="col-md-2 col-xs-2 col-sm-2">
                        <asp:Label ID="lblElemento" runat="server" Text="Elemento a Revisar " Font-Size="Medium" ForeColor="Black" CssClass="label"></asp:Label>
                    </div>
                    <div class="col-md-4 col-xs-4 col-sm-4">
                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <div class="col-md-2 col-xs-2 col-sm-2">
                        <asp:Label ID="lblUsuario" runat="server" Text="Responsable " Font-Size="Medium" ForeColor="Black" CssClass="label"></asp:Label>
                    </div>
                    <div class="col-md-4 col-xs-4 col-sm-4">
                ...
                <div class="col-md-3 col-xs-3 col-sm-3 col-md-offset-9 col-xs-offset-9 col-sm-offset-9">
                    ...
                    <asp:Button ID="Button2" runat="server" Text="Regresar" CssClass="btn btn-primary" OnClick="btnCancelar_Click" />
                </div>
                <%-- fin botones --%>
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <br />
