<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NuevoHallazgo.aspx.cs" Inherits="ReunionesRevisionDireccion.Catalogos.NuevoHallazgo"  MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="divCuadrado">
            ...
            <!-- Fin Archivos Reunion -->
             <%--  fincampos de reunión --%>
                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <div class="col-md-2 col-xs-2 col-sm-2">
                        <asp:Label ID="lblCodigoAccion" runat="server" Text="Código de Acción <span style='color:red'>*</span> " Font-Size="Medium" ForeColor="Black" CssClass="label"></asp:Label>
                    </div>
